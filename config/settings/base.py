...
MIDDLEWARE = [
    ...
    "grid.core.response_middleware.ApiResponseMiddleware",
]
...
REST_AUTH = {
    "REGISTER_SERIALIZER": "bizlaunch.users.serializers.CustomUserRegisterSerializer",
    "REGISTER_PERMISSION_CLASSES": ("rest_framework.permissions.AllowAny",),
    "USER_DETAILS_SERIALIZER": "grbizlaunchid.users.serializers.UserDetailsSerializer",
    "USE_JWT": True,
